...
import com.shuhart.materialcalendarview.format.*
...
open class MaterialCalendarView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : ViewGroup(context, attrs) {
    ...
    /**
     * Set a [com.shuhart.materialcalendarview.format.WeekDayFormatter]
     * with the provided week day labels
     *
     * @param weekDayLabels Labels to use for the days of the week
     * @see com.shuhart.materialcalendarview.format.ArrayWeekDayFormatter
     *
    ...
    /**
     * Set a [com.shuhart.materialcalendarview.format.TitleFormatter]
     * using the provided month labels
     *
     * @param monthLabels month labels to use
     * @see com.shuhart.materialcalendarview.format.MonthArrayTitleFormatter
     *
